...
var (
	...
	pctx = blueprint.NewPackageContext("github.com/Kolbasen/design-practice-1/build/jsbundle")
...
func (tb *testedBinaryModule) GenerateBuildActions(ctx blueprint.ModuleContext) {
	...
	println(config.BaseOutputDir)

	outPath := path.Join(config.BaseOutputDir, "js")
